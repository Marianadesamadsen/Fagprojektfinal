...
% Model with stochastic noise measurements. 
% It describes the dynamics of insulin and glucose concentration  
...
% derivative x'(t)) for one time point t with stochastic noise measurements.
% Function will be used for several simulations as a function handle.
% 
% INPUT:
%   t       - time
...
% the state vector x with stochastic noise measurements. 
% 
% PROJECT:
% Fagprojekt 2022
